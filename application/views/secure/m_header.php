...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url();?>template/metronic/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			...
			<a href="<?php echo base_url();?>">
                            <img alt="Logo" src="<?php echo base_url();?>assets/logo/Logo_FieldPass.png" style="min-width:100px;max-width:120px;"/>
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							<!--begin::Menu Nav-->
							<ul class="menu-nav">
								<li class="menu-item <?php echo isset($menu) && $menu == 'dashboard'? 'menu-item-active' : '';?>" aria-haspopup="true">
									<a href="<?php echo base_url();?>secure/dashboard" class="menu-link">
								...
								<li class="menu-item menu-item-submenu <?php echo isset($menu) && $menu == 'Players' ? 'menu-item-open menu-item-here' : '';?>" aria-haspopup="true" data-menu-toggle="hover">
										...
										<ul class="menu-subnav">
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Players Forms</span>
												</span>
											</li>
											<li class="menu-item menu-item-submenu <?php echo isset($sub_menu) && $sub_menu == 'player_form' ? 'menu-item-open menu-item-here' : '';?>" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:void(0);" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text">Players Form</span>
													<i class="menu-arrow"></i>
												</a>
												<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'player_form' ? 'menu-item-active' : '';?>" aria-haspopup="true">
															<a href="<?php echo base_url();?>secure/player_form" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">New Players Form</span>
															</a>
														</li>
														<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'update_player_form' ? 'menu-item-active' : '';?>" aria-haspopup="true">
															<a href="javascript:void(0);" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Update Players Form</span>
															</a>
														</li>
														<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'bulk_player' ? 'menu-item-active' : '';?>" aria-haspopup="true">
															<a href="<?php echo base_url();?>secure/bulk_player" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Player Bulk Upload</span>
															</a>
														</li>
													</ul>
												</div>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Players Listing</span>
												</span>
											</li>
											<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'player_listing' ? 'menu-item-active' : '';?>" aria-haspopup="true">
												<a href="<?php echo base_url();?>secure/listing/player" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Players Listing</span>
								...
								<li class="menu-item menu-item-submenu <?php echo isset($menu) && $menu == 'Clubs' ? 'menu-item-open menu-item-here' : '';?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:void(0);" class="menu-link menu-toggle">
										<i class="menu-icon fas fa-user"></i>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Clubs Forms</span>
												</span>
											</li>
											<li class="menu-item menu-item-submenu <?php echo isset($sub_menu) && $sub_menu == 'club_form' ? 'menu-item-open menu-item-here' : '';?>" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:void(0);" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text">Clubs Form</span>
													<i class="menu-arrow"></i>
												</a>
												<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'club_form' ? 'menu-item-active' : '';?>" aria-haspopup="true">
															<a href="<?php echo base_url();?>secure/club_form" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">New Club Form</span>
															</a>
														</li>
														<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'update_club_form' ? 'menu-item-active' : '';?>" aria-haspopup="true">
															<a href="javascript:void(0);" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Update Club Form</span>
															</a>
														</li>
													</ul>
												</div>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Clubs Listing</span>
												</span>
											</li>
											<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'club_listing' ? 'menu-item-active' : '';?>" aria-haspopup="true">
												<a href="<?php echo base_url();?>secure/listing/team" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Clubs Listing</span>
								...
								<li class="menu-section">
									<h4 class="menu-text">Competition Management</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item menu-item-submenu <?php echo isset($menu) && $menu == 'Leagues' ? 'menu-item-open menu-item-here' : '';?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:void(0);" class="menu-link menu-toggle">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Matches Listing</span>
												</span>
											</li>
											<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'matches_listing' ? 'menu-item-active' : '';?>" aria-haspopup="true">
												<a href="<?php echo base_url();?>secure/listing/match" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Matches Listing</span>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Match Forms</span>
												</span>
											</li>
											<li class="menu-item menu-item-submenu <?php echo isset($sub_menu) && $sub_menu == 'match_form' ? 'menu-item-open menu-item-here' : '';?>" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:void(0);" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text">Match Form</span>
													<i class="menu-arrow"></i>
												</a>
												<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'match_form' ? 'menu-item-active' : '';?>" aria-haspopup="true">
															<a href="<?php echo base_url();?>secure/match_form" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">New Match Form</span>
															</a>
														</li>
														<li class="menu-item <?php echo isset($menu_item) && $menu_item == 'update_match_form' ? 'menu-item-active' : '';?>" aria-haspopup="true">
															<a href="javascript:void(0);" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Update Match Form</span>
															</a>
														</li>
													</ul>
												</div>
								...
								<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
									...
									<ul class="menu-nav">
										<li class="menu-item menu-item-submenu menu-item-rel menu-item-active" data-menu-toggle="click" aria-haspopup="true">
											<a href="<?php echo base_url();?>template/metronic/dist/javascript:;" class="menu-link menu-toggle">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-left">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo base_url();?>template/metronic/dist/index.html" class="menu-link">
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo base_url();?>template/metronic/dist/javascript:;" class="menu-link">
															<span class="svg-icon menu-icon">
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														<a href="<?php echo base_url();?>template/metronic/dist/#" class="menu-link menu-toggle">
															<span class="svg-icon menu-icon">
							...
							<div class="topbar">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<form>
											<!--begin::Header-->
											<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo base_url();?>template/metronic/dist/assets/media/misc/bg-1.jpg)">
												<!--begin::Title-->
												...
												<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
													<li class="nav-item">
														<a class="nav-link active show" data-toggle="tab" href="<?php echo base_url();?>template/metronic/dist/#topbar_notifications_notifications">Alerts</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-toggle="tab" href="<?php echo base_url();?>template/metronic/dist/#topbar_notifications_events">Events</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-toggle="tab" href="<?php echo base_url();?>template/metronic/dist/#topbar_notifications_logs">Logs</a>
													</li>
												</ul>
												<!--end::Tabs-->
											</div>
											...
											<div class="tab-content">
												...
												<div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
													...
													<div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex flex-column font-weight-bold">
																<a href="<?php echo base_url();?>template/metronic/dist/#" class="text-dark text-hover-primary mb-1 font-size-lg">Cool App</a>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column font-weight-bold">
																<a href="<?php echo base_url();?>template/metronic/dist/#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Awesome SAAS</a>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column font-weight-bold">
																<a href="<?php echo base_url();?>template/metronic/dist/#" class="text-dark text-hover-primary mb-1 font-size-lg">Claudy Sys</a>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column font-weight-bold">
																<a href="<?php echo base_url();?>template/metronic/dist/#" class="text-dark text-hover-primary mb-1 font-size-lg">Trilo Service</a>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column font-weight-bold">
																<a href="<?php echo base_url();?>template/metronic/dist/#" class="text-dark text-hover-primary mb-1 font-size-lg">Bravia SAAS</a>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column font-weight-bold">
																<a href="<?php echo base_url();?>template/metronic/dist/#" class="text-dark text-hover-primary mb-1 font-size-lg">Express Wind</a>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column font-weight-bold">
																<a href="<?php echo base_url();?>template/metronic/dist/#" class="text-dark text-hover-primary mb-1 font-size-lg">Bruk Fitness</a>
													...
													<div class="d-flex flex-center pt-7">
														<a href="<?php echo base_url();?>template/metronic/dist/#" class="btn btn-light-primary font-weight-bold text-center">See All</a>
													</div>
													<!--end::Action-->
												</div>
												<!--end::Tabpane-->
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<!--begin:Header-->
										<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo base_url();?>template/metronic/dist/assets/media/misc/bg-1.jpg)">
										...
										<div class="row row-paddingless">
											<!--begin:Item-->
											<div class="col-6">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
											...
											<!--begin:Item-->
											<div class="col-6">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
													<span class="svg-icon svg-icon-3x svg-icon-success">
											...
											<!--begin:Item-->
											<div class="col-6">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
													<span class="svg-icon svg-icon-3x svg-icon-success">
											...
											<!--begin:Item-->
											<div class="col-6">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="d-block py-10 px-5 text-center bg-hover-light">
													<span class="svg-icon svg-icon-3x svg-icon-success">
								...
								<div class="dropdown">
									...
									<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
											<img class="h-20px w-20px rounded-sm" src="<?php echo base_url();?>template/metronic/dist/assets/media/svg/flags/226-united-states.svg" alt="" />
										</div>
									</div>
									<!--end::Toggle-->
									<!--begin::Dropdown-->
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
										...
										<ul class="navi navi-hover py-4">
											...
											<li class="navi-item">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="<?php echo base_url();?>template/metronic/dist/assets/media/svg/flags/226-united-states.svg" alt="" />
													</span>
											...
											<li class="navi-item active">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="<?php echo base_url();?>template/metronic/dist/assets/media/svg/flags/128-spain.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="<?php echo base_url();?>template/metronic/dist/assets/media/svg/flags/162-germany.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="<?php echo base_url();?>template/metronic/dist/assets/media/svg/flags/063-japan.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="<?php echo base_url();?>template/metronic/dist/#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="<?php echo base_url();?>template/metronic/dist/assets/media/svg/flags/195-france.svg" alt="" />
													</span>
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo $this->session->userdata('username') != '' ? $this->session->userdata('username') : '';?></span>
										<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold"><?php echo $this->session->userdata('username') != '' ? substr($this->session->userdata('username'),0,1) : '';?></span>
										</span>
									</div>
								</div>
								<!--end::User-->
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											{
												foreach($breadcrumbs as $breadkey=>$breadvalue)
													echo '<li class="breadcrumb-item text-muted"><a href="' .base_url().$breadvalue.'" class="text-muted">' . $breadkey . '</a></li>';  
											}
											?>
										</ul>
										<!--end::Breadcrumb-->
