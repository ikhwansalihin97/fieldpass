...
<html lang="en">
	...
	<head><base href="<?php echo base_url();?>">
		...
		<link href="<?php echo base_url();?>template/metronic/dist/assets/css/pages/error/error-4.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="error error-4 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo base_url();?>template/metronic/dist/assets/media/error/bg4.jpg);">
				<!--begin::Content-->
				<div class="d-flex flex-column flex-row-fluid align-items-center align-items-md-start justify-content-md-center text-center text-md-left px-10 px-md-30 py-10 py-md-0 line-height-xs">
					...
					<p class="display-4 text-danger font-weight-boldest mt-md-0 line-height-md"><a href="<?php echo base_url();?>"><i class="icon-3x fas fa-home text-danger"></i></a> Nothing left to do here.</p>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
		...
		<script src="<?php echo base_url();?>template/metronic/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
